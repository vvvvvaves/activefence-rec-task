...
def setup_gemini_logger():
    """
    Setup logger for Gemini API exceptions.
    ...
    log_file = os.path.join(log_dir, f'gemini_errors_{timestamp}.log')
...
def log_gemini_error(logger, post_id, text_length, error_message, error_details=None):
    """
    Log Gemini API error with structured information.
